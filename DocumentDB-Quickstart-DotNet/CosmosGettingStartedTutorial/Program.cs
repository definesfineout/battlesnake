...
namespace CosmosGettingStartedTutorial
{
    class Program
    {
        ...
        //private static readonly string EndpointUri = ConfigurationManager.AppSettings["LocalCosmosEndPointUri"];
        private static readonly string EndpointUri = "https://localhost:8081";

        // The primary key for the Azure Cosmos account.
        //private static readonly string PrimaryKey = ConfigurationManager.AppSettings["LocalCosmosPrimaryKey"];
